...
Order.create("user_id": 1, "product_id": 7, "purchased": true, "quantity": 1, "order_price": 20.99)
Order.create("user_id": 1, "product_id": 7, "purchased": true, "quantity": 1, "order_price": 20.99)
Order.create("user_id": 2, "product_id": 3, "purchased": true, "quantity": 1, "order_price": 20.99)
